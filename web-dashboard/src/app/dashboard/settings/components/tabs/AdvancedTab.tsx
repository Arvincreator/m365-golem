...
const EDITABLE_KEYS = new Set([
    ...
    "DISCORD_TOKEN", "DISCORD_AUTH_MODE", "DISCORD_ADMIN_ID", "DISCORD_CHAT_ID", "DISCORD_CHAT_OBSERVE_ALL", "USER_DATA_DIR", "GOLEM_TEST_MODE",
    ...
    "GOLEM_AUTONOMY_ENABLED", "GOLEM_AWAKE_INTERVAL_MIN", "GOLEM_AWAKE_INTERVAL_MAX", "GOLEM_REFLECTION_ENABLED", "GOLEM_REFLECTION_COOLDOWN_HOURS",
